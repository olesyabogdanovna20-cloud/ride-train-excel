...
function Features() {
  const items = [
    { icon: Trophy, t: "Обучение от чемпионов", d: "Программы разработаны экспертами с опытом международных соревнований. Вас готовят те, кто сам прошел путь к пьедесталу." },
    { icon: PlayCircle, t: "Практические видеоуроки", d: "Каждый урок — это конкретный навык, который вы сразу примените на тренировке." },
    { icon: Users, t: "Уровень подготовки", d: "Программы построены так, что результат получат как те, кто только начинает, так и действующие спортсмены." },
    { icon: Smartphone, t: "Мобильное обучение", d: "Полный доступ к урокам и материалам в приложении EMRI в любое время." },
  ];
  return (
          ...
          const card = (
            <div className="group rounded-2xl bg-card border border-border overflow-hidden hover:border-primary/50 transition h-full">
              <div className="aspect-video relative overflow-hidden grid place-items-center">
                ...
                <span className="absolute top-3 right-3 z-10 text-xs font-semibold bg-background/80 backdrop-blur px-2 py-1 rounded">
                  Бесплатно
                </span>
              </div>
              <div className="p-5">
      ...
      <div className="container-x">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2">
          <PriceCard
            ...
            title="Велоспорт"
            plans={[
              { p: "1 месяц", c: "1 900 ₽", url: "https://payform.ru/lrc4LXO/" },
              { p: "3 месяца", c: "3 990 ₽", url: "https://payform.ru/nbc4LYC/" },
          ...
          <PriceCard
            ...
            featured
            plans={[
              { p: "1 месяц", c: "3 300 ₽", url: "https://payform.ru/sic4M1o/" },
              { p: "3 месяца", c: "6 930 ₽", url: "https://payform.ru/tfc4M1S/" },
              { p: "12 месяцев", c: "19 800 ₽", badge: "Выгодно", url: "https://payform.ru/5dc4M2t/" },
            ]}
          />
        </div>
      </div>
  ...
  return (
    <footer className="border-t border-border py-10">
      <div className="container-x flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
       ...
       <a href="mailto:emri.sport@gmail.com" className="hover:text-foreground transition"> emri.sport@gmail.com </a>
